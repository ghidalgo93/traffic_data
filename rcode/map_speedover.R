...
#plot(newmap, xlim = c(-80, -75), ylim = c(38, 40), asp = 1)
#points(SpeedExceeded$Longitude, SpeedExceeded$Latitude, col = "red", cex = .6)
...
png("itsafuckingheatmap.png", width=4, height=4, units="in", res=300)
